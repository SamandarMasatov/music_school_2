...
<template>
  <div class="global_bg">
      ...
      >
        ...
        <div class="news_feature_text">
          ...
          <div class="news_feature_subtext">
            <h2 class="clamp_title_main">{{ item.title.uz }}</h2>
            <p class="news_data">28.01.2024</p>
            <p class="news_data clamp_desc_main" v-html="item.desc.uz"></p>
          </div>
        </div>
      </NuxtLink>
      <!-- News Other -->
        ...
        >
          ...
          <div class="news_other_text">
            ...
            <div class="news_other_title">
              ...
              <p class="news_other_data clamp_desc" v-html="item.desc.uz"></p>
            </div>
          </div>
        </NuxtLink>
      </div>
    ...
    <div class="new_btn">
      <NuxtLink to="/news"> <button>Yangiliklar</button></NuxtLink>
    </div>
  </div>
</template>
<style scoped>
